                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="relative flex-shrink-0">
                        <div className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-full bg-gradient-to-br from-[#e2001a] to-[#e2001a]/80 ring-2 ring-white shadow-sm">
                          {session.user?.name ? (
