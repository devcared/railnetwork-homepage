...
const footerLinks = {
  company: [
    ...
    { label: "Investoren", href: "/de/investoren" },
  ],
  legal: [
    { label: "AGBs", href: "/de/agb" },
  ...
  services: [
    ...
    { label: "API Dokumentation", href: "/de/api" },
    { label: "Status", href: "/de/status" },
    { label: "Changelog", href: "/de/changelog" },
  ],
};
...
const socialLinks = [
  {
    name: "LinkedIn",
    href: "https://linkedin.com/company/railnetwork",
    icon: (
  ...
  {
    name: "Twitter",
    href: "https://twitter.com/railnetwork",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "GitHub",
    href: "https://github.com/railnetwork",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        <path
          fillRule="evenodd"
