              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  {(item.startDate || item.endDate) && (
                    <div className="flex items-center gap-2 border-t border-slate-200 dark:border-slate-700/60 pt-3 text-xs text-slate-500 dark:text-slate-400">
      ...
      <Sheet open={showCreateItem} onOpenChange={setShowCreateItem} side="right" size="md">
        ...
        <SheetContent>
          <div className="space-y-4">
            <p className="text-sm text-slate-600 dark:text-slate-400">Eintragsformular wird hier angezeigt...</p>
          </div>
        </SheetContent>
        <SheetFooter>
          <button
