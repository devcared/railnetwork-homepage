        ...
        <div className="px-6 py-4 lg:px-8 lg:py-5">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <button className="hidden items-center gap-2 rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 sm:flex">
        ...
        <div className="mx-auto max-w-7xl">
              ...
              return (
                ...
                >
                  ...
                  <div className="mb-4">
                    ...
                    <p className="text-sm font-medium text-slate-600">{vehicle.type}</p>
                  </div>
                  ...
                  <div className="space-y-2 border-t border-slate-100 pt-4">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-semibold text-slate-900">{vehicle.utilization}%</span>
                    </div>
          ...
          {filteredFleet.length === 0 && (
            <div className="py-16 text-center">
              ...
              <p className="mt-4 text-sm font-medium text-slate-500">Keine Fahrzeuge gefunden</p>
            </div>
          )}
        </div>
      </div>
